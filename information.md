...
> Имеются ввиду бесплтные подарки. За платные в 3 раза больше ▸Pp

<br> **Обязательно, перед тем как отправлять подарок, поставте галочку возле "Показывать текст и моё имя только получателю"! Так-же не забудь указать свой игровой никнейм.**
