# PILTOVER| Информация
> Если ты сюда попал через браузер стима, то к сожалению быстрый переход не будет работать. Вот ссылка на эту тему 
> Можешь окрыть её в своем браузере, для удобсва пользования.
